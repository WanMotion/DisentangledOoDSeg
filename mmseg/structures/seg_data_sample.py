...
class SegDataSample(BaseDataElement):
    ...
    @property
    def img_ori_1(self)->PixelData:
        return self._img_ori_1

    @img_ori_1.setter
    def img_ori_1(self,value:PixelData)->None:
        self.set_field(value,'_img_ori_1',dtype=PixelData)

    @img_ori_1.deleter
    def img_ori_1(self)->None:
        del self._img_ori_1

    @property
    def img_ori_2(self)->PixelData:
        return self._img_ori_2

    @img_ori_2.setter
    def img_ori_2(self,value:PixelData)->None:
        self.set_field(value,'_img_ori_2',dtype=PixelData)

    @img_ori_2.deleter
    def img_ori_2(self)->None:
        del self._img_ori_2

    @property
    def pred_reconstruct(self) -> BaseDataElement:
        return self._pred_reconstruct

    @pred_reconstruct.setter
    def pred_reconstruct(self, value: BaseDataElement) -> None:
        self.set_field(value, '_pred_reconstruct', dtype=BaseDataElement)

    @pred_reconstruct.deleter
    def pred_reconstruct(self) -> None:
        del self._pred_reconstruct