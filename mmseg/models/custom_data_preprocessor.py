...
def stack_batch_training(inputs: List[torch.Tensor],
    ...
    def forward(self, data: dict, training: bool = False) -> Dict[str, Any]:
        ...
        if type(inputs[0])==tuple:
            ...
            for i in range(len(inputs[0])):
                inputs_a.append(inputs[0][i])
                inputs_a.append(inputs[1][i])
            inputs=inputs_a
        ...
        if training:
            ...
            inputs, data_samples = stack_batch_training(
                inputs=inputs,
